...
export interface WeatherTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WEATHER_API_PRICE"
      | "allowance"
  ...
  encodeFunctionData(
    functionFragment: "WEATHER_API_PRICE",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getWeatherApiPrice",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "hasWeatherApiAccess",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface WeatherToken extends BaseContract {
  connect(runner?: ContractRunner | null): WeatherToken;
  waitForDeployment(): Promise<this>;

  interface: WeatherTokenInterface;
  ...
  WEATHER_API_PRICE: TypedContractMethod<[], [bigint], "view">;
  ...
  getWeatherApiPrice: TypedContractMethod<[], [bigint], "view">;

  hasWeatherApiAccess: TypedContractMethod<
    [user: AddressLike],
    [boolean],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "WEATHER_API_PRICE"
  ...
  getFunction(
    nameOrSignature: "getWeatherApiPrice"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "hasWeatherApiAccess"
